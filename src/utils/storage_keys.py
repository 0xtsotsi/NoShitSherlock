...
class PromptCacheKey(BaseModel):
    ...
    @field_validator("repo_name", "step_name")
    @classmethod
...
class PromptDataKey(BaseModel):
    ...
    def parse_from_key(cls, storage_key: str) -> Optional["PromptDataKey"]:
        ...
        try:
            ...
            if len(parts) == 3:
                return cls(repo_name=parts[0], step_name=parts[1], unique_id=parts[2])
        except Exception:
            pass
        return None
...
class KeyNameCreator:
    ...
    def create_prompt_cache_key(
        repo_name: str, step_name: str, commit_sha: str, prompt_version: str = "1"
    ) -> PromptCacheKey:
        """
    ...
    def create_investigation_metadata_key(
        repo_name: str, analysis_type: str = "investigation"
        ...
        """
        return InvestigationMetadataKey(repo_name=repo_name, analysis_type=analysis_type)

    @staticmethod
    def create_prompt_data_key(repo_name: str, step_name: str, unique_id: str) -> PromptDataKey:
        """
        ...
        """
        return PromptDataKey(repo_name=repo_name, step_name=step_name, unique_id=unique_id)
    ...
    @staticmethod
    def parse_prompt_cache_key(storage_key: str) -> PromptCacheKey | None:
        """
        Parse a storage key back into a PromptCacheKey object.
    ...
    @staticmethod
    def parse_analysis_result_key(storage_key: str) -> AnalysisResultKey | None:
        """
        Parse a storage key back into an AnalysisResultKey object.
    ...
    @staticmethod
    def parse_investigation_metadata_key(storage_key: str) -> InvestigationMetadataKey | None:
        """
        Parse a storage key back into an InvestigationMetadataKey object.
    ...
    @staticmethod
    def parse_prompt_data_key(storage_key: str) -> PromptDataKey | None:
        """
        Parse a storage key back into a PromptDataKey object.
