...
class DynamoDBPromptContext(PromptContextBase):
    ...
    def get_result(self) -> str | None:
        ...
        result = self._dynamodb_client.get_analysis_result(self.result_reference_key)
...
class DynamoDBPromptContextManager(PromptContextManagerBase):
    ...
    def create_context_for_step(
        ...
        # The return type is DynamoDBPromptContext (subclass of PromptContextBase)
