...
class ActivityWrapper:
    ...
    def __init__(self, workflow_context: Any | None = None):
        """
    ...
    async def execute_activity(
        ...
        **kwargs,
        ...
        """
        if (
            self._is_temporal_context
            and self.workflow_context is not None
            and hasattr(self.workflow_context, "execute_activity")
        ):
