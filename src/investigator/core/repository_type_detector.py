...
class RepositoryTypeDetector:
    ...
    def get_prompts_directory(
        self, repo_path: str, repo_type: str | None = None, repo_url: str | None = None
    ) -> str:
        """
        ...
        _ = repo_path  # Unused, kept for logging purposes
        _ = repo_url  # Unused, kept for backward compatibility
        ...
        if not prompts_path.exists():
            self.logger.warning(
                f"Prompts directory not found: {prompts_path}, falling back to generic"
            )
